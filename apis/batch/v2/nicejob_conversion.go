...
import (
	...
	"strings"
	v1 "tutorial.io/learn/apis/batch/v1"
)

// ConvertTo converts this CronJob to the Hub version (v1).
func (src *NiceJob) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*v1.NiceJob)
	...
	// rest of conversions are pritty simple.
	// ObjectMeta
...
func (dst *NiceJob) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1.NiceJob)
